...
![AskBeforeAnswer System & Research Architecture](assets/architecture.svg)

The architecture separates the user-facing inference runtime from the data, training, and evaluation pipelines, with Hugging Face Hub and Weave providing shared model and experiment infrastructure.

For the canonical Mermaid source, see [`docs/diagrams/architecture.mmd`](docs/diagrams/architecture.mmd).
