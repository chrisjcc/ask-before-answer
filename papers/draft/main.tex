...
\vspace{0.3cm}
\includegraphics[width=0.8\textwidth]{figures/grpo_reward_components.png}
\caption{Detailed GRPO training metrics: Total Training Reward (top left), KL Divergence from the reference policy (top right), and the convergence of individual programmatic reward components (bottom).}
